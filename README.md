...
``` dart 
  ...
  video_player_controls:
    git:
      url: 'https://github.com/alerogeriodj/video_player_controls.git'
      ref: another
...
2ª Opção: Mobile (Flutter e Banco de Dados)
